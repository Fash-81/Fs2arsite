<template>
    <NavBar />
    <h1 class="text-5xl mt-10 text-center  text-white font-Negar">بنرها</h1>
    <div class="overflow-x-auto items-center sm:rounded-lg w-7/8 mx-20 mb-10 ">
        <table class=" w-full text-xl text-center  font-Negar   mt-20">
            ...
            <tbody v-for="Portfilio in getBanners" :key="Portfilio">
                <tr class=" border-b bg-gray-900/40 border-gray-700 text-white">
                    <td class=" flex justify-center py-4 px-10 ">
                        <img class="   rounded" :src="'http://127.0.0.1:8000/media/p/' + Portfilio.topic"
                            :alt="Portfilio.topic" width="150" height="300">
                    </td>
...
export default {
    ...
    computed: {
        getBanners() {
            return this.nemuoneKareman.filter(b => b.case === 'بنر')
        }
    },
    mounted() {
